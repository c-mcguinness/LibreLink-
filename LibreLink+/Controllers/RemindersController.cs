...
namespace LibreLink_.Controllers
{
    public class RemindersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ReminderId,ReminderTime,ReminderMessage")] Reminder reminder)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ReminderId,ReminderTime,ReminderMessage")] Reminder reminder)
        {
            if (ModelState.IsValid)
            {
